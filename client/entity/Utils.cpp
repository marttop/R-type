...
void Utils::vectorNormalize(sf::Vector2f &vector)
{
...
float Utils::vectorSize(const sf::Vector2f &vector1, const sf::Vector2f &vector2) const
{
    float magnitude = sqrt(pow(vector2.x - vector1.x, 2) + pow(vector2.y - vector1.y, 2));
    return (magnitude);
}

void Utils::rotatePointAroundCenter(sf::Vector2f &point, const sf::Vector2f &center, const float &angle_rad)
{
...
float Utils::dotProduct(const sf::Vector2f &vector_a, const sf::Vector2f &vector_b) const
{
    return ((vector_a.x * vector_b.x) + (vector_a.y * vector_b.y));
}

void Utils::posDebug(const sf::Vector2f &pos, sf::RenderWindow &window)
{
    sf::CircleShape dot;
...
bool Utils::segmentIntersectsRectangle(const sf::FloatRect &rect, const sf::Vector2f &a_p1, const sf::Vector2f &a_p2) const
{
