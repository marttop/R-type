...
void BoomrangBulletC::update()
{
    ...
    _particleSystem.update(sf::Vector2f{40, 40}, sf::Vector2f{_pos.x + _sprite.getGlobalBounds().width / 2, _pos.y + _sprite.getGlobalBounds().height / 2}, sf::Vector2f{_pos.x + _sprite.getGlobalBounds().width / 2, _pos.y + _sprite.getGlobalBounds().height / 2}, sf::Color(0, 255, 255, 200), sf::Color(255, 255, 255, 50), 10, 1);
